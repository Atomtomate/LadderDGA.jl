...
conv_tsc_02, λm_tsc, λd_tsc, μ_it_tsc_02, G_ladder_it_tsc_02, Σ_ladder_it_tsc_02, tr_tsc_02 = LadderDGA.LambdaCorrection.run_tsc(χm, γm, χd, γd, λ₀, h; mixing=0.3, trace=true, maxit=10, tc=false) 
