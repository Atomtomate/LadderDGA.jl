...
# Hacker Loesung um mein Verstaendnis vom dem was Julian mir ueber den Code erzaehlt effektiv zu bewirken
# Wenn mein Verstaendnis korrekt ist, dann sollte Σ_loc=0 und dafuer (n, μ) wie im Fortran-Code zu verwenden.
mP.μ = mP.U/2
mP.n = 1.0
# Ende Hackerloesung
