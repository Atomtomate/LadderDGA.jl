...
@timeit LadderDGA.to "new λ par" λsp_new_par = λ_correction(:sp_ch, imp_density, nlQ_sp, nlQ_ch, gLoc_rfft, λ₀, kG, mP, sP, workerpool=wp)
@info "parallel data agrees with sequential: " all(λsp_new .≈ λsp_new_par)
