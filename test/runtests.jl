...
sP_1 = SimulationParameters(1,2,3,true,nothing,1.5, 1:3,0.1,false,false)
sP_2 = SimulationParameters(10,10,0,true,nothing,NaN,-20:20,0.0,true,false)
...
sP_grid_s1 = SimulationParameters(4,5,2,true,nothing,1.5,1:3,0.1,false,false)
sP_grid_s0 = SimulationParameters(4,5,2,false,nothing,1.5,1:3,0.1,false,false)
